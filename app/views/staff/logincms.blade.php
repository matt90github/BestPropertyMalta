<!-- CMS Staff Member Login Page -->

@section('title', 'Best Property Malta | CMS Login')

	@include('common.staff_errors')

	{{ Form::open(array('url'=>'cms/staff/signedin', 'class'=>'form-signin', 'id'=>'staff-login-details', 'role'=>'form', 'method' => 'POST')) }}
	{{ Form::token() }}
