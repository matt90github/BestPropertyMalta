<!-- IMS Create Customer Page -->

@section('title', 'Best Property Malta | New Customer')
@include('common.customer_errors')

{{ Form::open(array('url'=>'ims/customers/create', 'class'=>'form-horizontal', 'id'=>'customer-details',  'role'=>'form')) }}
   
   <h3 class="form-signup-heading">New Customer</h3>
   ...
   <div class="form-group">
   		{{ Form::label('customer_isActive', 'Active?', array('class'=>'col-sm-2 control-label')) }} 

   		<div class="col-sm-1">
   			{{ Form::checkbox('customer_isActive', Input::old('customer_isActive'), true, array('class'=>'form-control', 'placeholder'=>'Active?')) }} 
   		</div>
   </div>
   
   <div class="form-custom-buttons">
         <a id="customer" href="#" class="btn btn-primary" onclick="$(this).closest('form').submit();return false;">Add Customer</a>
