<!-- IMS Edit Customer Page -->

@section('title', 'Best Property Malta | Edit Customer')
@include('common.customer_errors')

{{ Form::open(array('url'=>'ims/customers/update', 'class'=>'form-horizontal', 'id'=>'customer-details',  'role'=>'form', 'method' => 'PUT')) }}

   <h3 class="form-signup-heading">Edit Customer</h3>
...
<!-- 	<div class="form-group">
   ...
   <div class="form-group">
   		...
   		<div class="col-sm-1">
   			{{ Form::checkbox('customer_isActive', $customer->customer_isActive, $checkbox_enabled, array('class'=>'form-control', 'placeholder'=>'Active?')) }} 
   		</div>
   </div>
