<!-- Official Website Change Customer Password Page -->

@section('title', 'Best Property Malta | Change Password')
@include('common.customer_errors')

{{ Form::open(array('url'=>'customerprofile/updatepassword', 'class'=>'form-horizontal', 'id'=>'customer-password-details',  'role'=>'form', 'method' => 'PUT')) }}
